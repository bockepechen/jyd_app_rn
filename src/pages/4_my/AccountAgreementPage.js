        ...
        return (
          <View 
            ...
            <View style={{width:scaleSize(1134), height:scaleSize(1374), backgroundColor:'#ffffff', borderRadius:10}}>
              <View style={{flexDirection:'row',marginTop:scaleSize(87),marginLeft:scaleSize(111)}}>
                <Text style={{fontSize:scaleSize(36),color:'#3b92f0'}}>{'江西银行存管投资协议'}</Text>
                <View style={{marginLeft:scaleSize(201)}}>
                  
                  <Text style={{fontSize:scaleSize(36),color:'#3b92f0'}}>{'已阅读'}</Text>
                </View>
              </View>
              <View style={{marginTop:scaleSize(87),marginLeft:scaleSize(111)}}>
                <View>
                  <Text>{'《江西银行资金存管账户投资协议》'}</Text>
                </View>
              </View>
            </View>
