...
export default class AuthPhoneNumNewPage extends Component{
    constructor(props){
        super(props)
    ...
    renderInputView() {
        ...
        return (
          <View 
            ...
            <View style={{width:scaleSize(1134), height:scaleSize(250), backgroundColor:'#ffffff', borderRadius:10, alignItems:'center'}}>
