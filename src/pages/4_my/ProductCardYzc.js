    ...
    return (
        <View style={{marginTop:scaleSize(40)}}>
            <View style={{flexDirection:'column'}}>
                ...
                <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:scaleSize(18)}}>
                    <Text style={{marginLeft:scaleSize(165),fontSize:scaleSize(36),color:'#989898'}}>{'转出完成时间:'}</Text>
                    <Text style={{marginRight:scaleSize(165),fontSize:scaleSize(36),color:'#989898'}}>{item.realendtime ? this.getDate2(item.realendtime) : null}</Text>
                </View>
            </View>
            <TouchableOpacity
                onPress={()=>{this.ckxy()}}
        ...
        <View>
            ...
            >
                ...
                >
                    ...
                    <View style={{marginTop:scaleSize(66),flexDirection:'row',justifyContent:'center'}}>
                        <View style={{}}>
                        ...
                        <View style={{marginLeft:scaleSize(155)}}>
                            <Text style={{fontSize:scaleSize(48),color:'#998675',height:scaleSize(48)}}>{Utils.formatMoney(this.paraData.arrivledinterest,2)}</Text>
