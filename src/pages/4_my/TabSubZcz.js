...
import ProductCardZcz from './ProductCardZcz';

let isAndroid = Platform.OS==='android'?true:false;
export default class TabSubZcz extends Component {
  constructor(props) {
    super(props);
  ...
  async getInfoData() {
    ...
    global.NetReqModel.Type = await "2";
    ...
    .then((result) => {
      ...
      if(result.return_code == '0000'){
        ...
        totalList = totalList.concat(result.investRecords);
        this.setState(
          {
            httpRes : result,
            list : totalList,
