...
export default class ProductCardMain extends Component {
  ...
  render() {
    let top1 = 
        <Text style={{marginTop:isIOS?scaleSize(63):scaleSize(51), fontWeight:'bold', fontSize:scaleSize(60), color:'#ff3a49'}}>{'嘉季丰'}</Text>
    let top2 = 
      <View style={{marginTop:isIOS?scaleSize(63):scaleSize(51), width:GlobalStyles.WINDOW_WIDTH, flexDirection:'row', alignItems:'flex-end'}}>
        <Text style={{marginLeft:scaleSize(148), fontWeight:'bold', fontSize:scaleSize(60), color:'#ff3a49'}}>{'嘉季丰'}</Text>
        <Text style={{marginLeft:scaleSize(477), fontSize:scaleSize(48), color:'#998675'}}>{'剩余 100000元'}</Text>
      </View>
      ...
      <TouchableHighlight
        ...
        <View style={{marginTop:scaleSize(this.props.top),height:scaleSize(636), flexDirection:'column', alignItems:'center'}}>
          <ImageBackground 
            ...
            {this.props.isRestMoney?top2:top1}
            ...
            <View style={{marginTop:isIOS?scaleSize(30):scaleSize(24), width:GlobalStyles.WINDOW_WIDTH, height:scaleSize(90), flexDirection:'row', alignItems:'flex-end', justifyContent:'center'}}>
              <View style={{ height:scaleSize(72)}}>
                <Text style={{fontSize:scaleSize(72), fontWeight:'200', color:'#998675'}}>{6.24}</Text>
              </View>
              ...
              <View style={{ height:scaleSize(90)}}>
                <Text style={{fontSize:scaleSize(90), fontWeight:'200', color:'#ff3a49'}}>{1.76}</Text>
              </View>
              <View style={{ height:scaleSize(54)}}>
            ...
            <Text style={{marginTop:isIOS?scaleSize(54):scaleSize(48), fontSize:scaleSize(48), color:'#998675'}}>{'服务期限 90天'}</Text>
          </ImageBackground>
          <TouchableHighlight
            underlayColor='rgba(0,0,0,0)'
            onPress={()=>{console.log('')}}
